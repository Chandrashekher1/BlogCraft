      ...
      <div className="container mx-auto flex justify-between items-center">
        <ul className="hidden md:flex space-x-6 text-lg">
          ...
          <Link to="/blog-generator">
            <button className='cursor-pointer border border-transparent hover:border-white px-6 py-2 rounded-lg flex' onClick={scrollToTop} ref={topRef}> <span className='my-1 mx-1'>{<FaRobot />}</span> AI Writer</button>
          </Link>
